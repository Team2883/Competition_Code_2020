...
public class Turret extends SubsystemBase 
{
  ...
  final public WPI_TalonFX m_Shooter1 = new WPI_TalonFX(Constants.ShooterMotor1);
  final public WPI_TalonFX m_Shooter2 = new WPI_TalonFX(Constants.ShooterMotor2);
  // final public SpeedControllerGroup m_Shooter = new SpeedControllerGroup(m_Shooter1, m_Shooter2);
  ...
  public Turret()
  {
    m_Shooter1.selectProfileSlot(1, 0);
  ...
  {
  m_Shooter1.selectProfileSlot(0, 0);
    if (Shooting)
      m_Shooter1.set(0);
    else
      m_Shooter1.set(.65);
