...
import frc.robot.commands.ShooterGroup;
...
/**------------------------------------------------- */
  ...
  private void configureButtonBindings() 
  {
    ...
    final JoystickButton AgitatorButton = new JoystickButton(stick, Constants.Agitator);
    ...
    final JoystickButton HoodSolenoidButton = new JoystickButton(stick, Constants.Hoodsolenoid);
    ...
    AgitatorButton.whenPressed(new SensorReset(m_driveTrain));
    AutoTurnButton.whileHeld(new ShooterGroup(m_turret, m_harvester));  //  TEST!!!
