...
public final class Constants 
{
    ...
    public static final int Agitator = 7;   //  Back Button
    public static final int AutoTurnButton = 3; // X Button
    public static final int Harvest = 1; // A Button
    public static final int HarvestSolenoid = 8; // Start Button
    public static final int HighShootButton = 4; // Y Button
    public static final int Hoodsolenoid = 6;   //  Right Bumper
