...
public final class Constants 
{
    ...
    public static final int kickupButton = 2; // B Button
   ...
   // public static final int ShifterButton = 1; // A Button
    ...
    public static final int AgitatorButton = 8;
    ...
    public static final int KickupMotor = 10;
    public static final int KickMotor = 18;
